...
protected:
	IDirect3DStateBlock9* m_pStateBlock;			// D3D9存储块
	ID3DXSprite*		m_pSprite;					// D3DX点精灵
...
public:
	...
	ID3DXSprite*			CERASUSRESOURCEMANAGER_CALLMETHOD	GetSprite()			const;			// 获取精灵接口指针
...
public:
	...
	HRESULT CERASUSRESOURCEMANAGER_CALLMETHOD	OnD3D9CreateDevice(LPDIRECT3DDEVICE9 pD3D9Device);	// 创建设备
